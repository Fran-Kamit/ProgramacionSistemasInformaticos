package unidad07.Actividad7_12.Class;
...
public class Lista {
    ...
    public void  insertarLista (Lista nuevaLista){
        //1. Longitud de la lista inicial
    ...
    /////////////////////////////////////////
    //1. Para concatenar dos tablas, vamos a crear una tercera donde se guardará
    public Lista concatenarTablas(Lista l1, Lista l2){
        ...
        System.out.println("\n El resultado de concatenar la lista1 " + Arrays.toString(l1.elemento) + " y la lista2 " +
                Arrays.toString(l2.elemento));
        return nuevaLista;
    }
}